...
@section('content')
    <div class="page-content">
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
            <div>
                <h4 class="mb-3 mb-md-0">Welcome to Anvica Radius Manager</h4>
            </div>
        </div>
              ...
              <div class="card-body">
                ...
                <div class="row mb-3">
                  <div class="col-6 d-flex justify-content-end">
                    <div>
                      <label class="d-flex align-items-center justify-content-end tx-10 text-uppercase fw-bolder">Total balance <span class="p-1 ms-1 rounded-circle bg-secondary"></span></label>
                ...
                <div class="d-grid">
                  <button class="btn btn-primary">Upgrade balance</button>
                </div>
              </div>
            </div>
          </div>
